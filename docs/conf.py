...
"""
openedx-blockstore-relay documentation build configuration file.
...
project = 'openedx-blockstore-relay'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Open edX Blockstore Relay'
...
#
# html_title = 'openedx-blockstore-relay v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Django plugin application providing a data and signal relay between Open edX and Blockstore.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_blockstore_relay'),
                os.path.join(root_path, 'openedx_blockstore_relay/migrations')])
